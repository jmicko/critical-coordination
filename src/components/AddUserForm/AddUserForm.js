      ...
      return (
         <div>
            <form className="formPanel metal">
               ...
               <input
                  required
                  placeholder="email" onChange={(event) => this.handleChange(event, 'email')}
                  value={this.state.newUser.email}></input>
               <select
                  required
               ...
               <input
                  ...
                  value={this.state.newUser.first_name}></input>
               <input
                  required
                  placeholder="Last Name"
                  onChange={(event) => this.handleChange(event, 'last_name')}
                  value={this.state.newUser.last_name}></input>
               <input
                  required
                  placeholder="password"
                  onChange={(event) => this.handleChange(event, 'password')}
                  value={this.state.newUser.password}></input>
               ...
               <button
                  className="button"
                  type="submit"
                  onClick={(event) => this.addUser(event)}>Add User</button>
            </form>
         </div>
      );
   }
